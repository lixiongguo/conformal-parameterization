 ...
 */
class RicciFlow : public ConeParameterization {
public:
    // constructor
    ...
    // setConeSingulars() is inherited from ConeParameterization
    // target curvature K̄ = 2π - Θ̂ is handled in setTargetCurvature()
...
protected:
    ...
    // coneSingulars is inherited from ConeParameterization
