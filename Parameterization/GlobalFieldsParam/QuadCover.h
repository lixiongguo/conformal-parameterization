 ...
 */
class QuadCover : public GlobalFieldsParameterization {
public:
    ...
    void setCrossField(const Eigen::MatrixXd& dirs) override;
...
protected:
    ...
    Eigen::MatrixXd externalFaceDirs;   // original external dirs (preserved after smoothing)
